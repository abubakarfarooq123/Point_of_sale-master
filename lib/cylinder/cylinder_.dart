...
import 'package:pos/cylinder/add_cylinder.dart';
...
class _CylinderState extends State<Cylinder> {
  ...
  Future<List<DocumentSnapshot>> fetchEmployeeData() async {
    QuerySnapshot snapshot = await firestore.collection('cylinder').get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        rows: List<DataRow>.generate(data.length, (index) {
                          ...
                          String cylinder = employeeData['count'].toString();
                          String cylinder_today_price = employeeData['today_amount'].toString();
                          ...
                          return DataRow.byIndex(
                            ...
                            cells: [
                              ...
                              DataCell(Text(cylinder_today_price !=null ? cylinder_today_price : '' )),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => Add_Cylinder()));
        },
          ...
          actions: [
            ...
            TextButton(
              onPressed: selectedRowIndex != -1
                ...
                firestore.collection('cylinder').doc(selectedEmployeeId).delete().then((value) {
