...
class Brand_Report extends StatefulWidget {
  const Brand_Report({super.key});

  @override
  State<Brand_Report> createState() => _Brand_ReportState();
}

class _Brand_ReportState extends State<Brand_Report> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("Select Brand:",style: GoogleFonts.poppins(
                            color: Colors.black,
                            fontWeight: FontWeight.bold,
                            fontSize: 17
                        ),),
                      ...
                      SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          rows: List<DataRow>.generate(data.length, (index) {
                            ...
                            String title = employeeData['title'].toString();
                            String item = employeeData['item'].toString();
                            return DataRow(
                              cells: [
