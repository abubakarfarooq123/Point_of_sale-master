...
class Taxes_Report extends StatefulWidget {
  const Taxes_Report({super.key});

  @override
  State<Taxes_Report> createState() => _Taxes_ReportState();
}

class _Taxes_ReportState extends State<Taxes_Report> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("Select Tax:",style: GoogleFonts.poppins(
                            color: Colors.black,
                            fontWeight: FontWeight.bold,
                            fontSize: 17
                        ),),
