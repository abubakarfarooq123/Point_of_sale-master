...
class Supplier_statement_Report extends StatefulWidget {
  const Supplier_statement_Report({super.key});

  @override
  State<Supplier_statement_Report> createState() =>
      _Supplier_statement_ReportState();
}

class _Supplier_statement_ReportState extends State<Supplier_statement_Report> {
      ...
      builder: (context, snapshots) {
        if (snapshots.connectionState == ConnectionState.waiting) {
          ...
          salesData.forEach((transactionData) {
            ...
            var tenderedAmount = transactionData['paid'];
            double finalAmount = transactionData['due'];
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return SingleChildScrollView(
          child: DataTable(
            columns: [
              DataColumn(label: Text('PUR #$purchase')),
            ],
            rows: tableData,
          ),
        );
